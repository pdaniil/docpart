...
function start_table()
{
	...
	if($current_page > 1)
	{
		...
		<TABLE style="width:1080px; height:0px; " CELLSPACING=0>
			<tr>
				<td style="width:3px;"></td>
				<td style="padding-left:2px;">Универсальный передаточный документ № <?php echo $order_record["id"]; ?> от <?php echo date("d", $order_record["time"]); ?> <?php echo get_month($order_record["time"]); ?> <?php echo date("Y", $order_record["time"]); ?> г.</td>
				<td style="text-align:right;">Лист <?php echo $current_page; ?></td>
			</tr>
		</TABLE> 
...
function end_all()
{
	...
	<TD CLASS="R19C15"><?php echo print_price($itogo_all_price_sum); ?></TD>
	<TD CLASS="R19C20"><SPAN></SPAN></TD>
	<TD CLASS="R19C21"><SPAN></SPAN></TD>
	<TD CLASS="R19C22"><SPAN></SPAN></TD>
	<TD><SPAN></SPAN></TD>
...
//Тестовый запрос
$need_count_rows_for_test = 22;//Какое количество строк вывести для теста
...
while( $order_item = $order_items_query->fetch() )
{
	...
	<TD CLASS="R18C2"><?php echo $order_item["article"];?></TD>
...
<TD CLASS="R21C1" ROWSPAN=4>Документ составлен на<BR><?php echo $current_page-1; ?> листах</TD>
