...
class ixora_enclosure
{
	...
	public function __construct($article, $storage_options)
	{
        ...
        curl_setopt($ch, CURLOPT_URL, "http://ws.ixora-auto.ru/soap/ApiService.asmx/FindXML?AuthCode=".$AuthCode."&Number=$article&StockOnly=false&SubstFilter=All&Maker=");
		...
		if($DocpartSuppliersAPI_Debug->suppliers_api_debug)
		{
			...
			$DocpartSuppliersAPI_Debug->log_api_request("Получение остатков по артикулу ".$article, "http://ws.ixora-auto.ru/soap/ApiService.asmx/FindXML?AuthCode=".$AuthCode."&Number=$article&StockOnly=false&SubstFilter=All&Maker=", htmlspecialchars($curl_result, ENT_QUOTES, "UTF-8"), print_r($php_object, true) );
		}
