...
<div style="padding-right:20px;">
	...
	<select id="group_select" onchange="groupChanged();" style="width:100%;" class="form-control">
		<option value="shiny_letnie">Летние</option>
		<option value="shiny_zimnie">Зимние</option>
		<option value="shiny_vsesezonnye">Всесезонные</option>
		<option value="shiny_mototsikletnie">Мотоциклетные</option>
	</select>
</div>
...
function showProducts()
{
	...
	for(var i=CurrentPage*Products_per_page; i < Products.length && printed < Products_per_page; i++)
	{
		...
		//Кнопка "Подробнее"
		html += "<div class=\"product_page_button\"><a href=\"/shop/katalogi-ucats/shiny/tovar?group="+document.getElementById("group_select").value+"&tovar="+Products[i].id+"\" class=\"bread_crumbs_a\">Подробнее</a></div>";
